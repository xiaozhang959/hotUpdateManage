...
async function requireEncryptedPayload(rawPayload: unknown) {
...
export async function parseLoginEncryptedPayload(rawPayload: unknown) {
  const payload = await requireEncryptedPayload(rawPayload)
  return {
...
export async function parseRegisterEncryptedPayload(rawPayload: unknown) {
  const payload = await requireEncryptedPayload(rawPayload)
  return {
...
export async function parseInitEncryptedPayload(rawPayload: unknown) {
  const payload = await requireEncryptedPayload(rawPayload)
  return {
...
export async function parseResetPasswordEncryptedPayload(rawPayload: unknown) {
  const payload = await requireEncryptedPayload(rawPayload)
  return {
...
export async function parseProfileEncryptedPayload(rawPayload: unknown) {
  const payload = await requireEncryptedPayload(rawPayload)
  return {
