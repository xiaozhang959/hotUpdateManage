      ...
      case 'S3': return (
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <Input value={form.config?.endpoint||''} onChange={e=>setForm({...form, config:{...form.config, endpoint:e.target.value}})} placeholder="可选，例如 https://s3.us-east-1.amazonaws.com"/>
          </div>
          <div>
            <Label>publicBaseUrl</Label>
